...
class HabitDTO:
    ...
    goal_unit: str | None
    schedule_type: str          # 'daily' | 'weekdays' | 'custom'
    is_active: bool
    created_at: datetime
...
class HabitService:
    """
    Coordinates habit CRUD and completion marking.

    Parameters
    ----------
    repository:
        Data-access object.  Must expose the methods used below.
    achievement_service:
        Optional; if provided, achievements are checked after every log.
    """
